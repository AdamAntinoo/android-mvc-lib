...
import org.dimensinfin.android.mvc.models.MVCRootNode;
import org.dimensinfin.core.model.RootNode;

import java.util.List;

public class RootController extends AAndroidController<MVCRootNode> {
	...
	/**
	 * Most of root parts should order the result by alphabetical name but this should be configurable. If the sort flag
	 * is active and the nodes are INamed then sort them.
	 */
	@Override
