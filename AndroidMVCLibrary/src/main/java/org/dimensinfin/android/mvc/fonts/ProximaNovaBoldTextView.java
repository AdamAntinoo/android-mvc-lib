...
public class ProximaNovaBoldTextView extends TextView {
	...
	private void init(final AttributeSet attrs) {
		if (!this.isInEditMode()) {
			ProximaNovaBoldTextView.typefaceName = Typeface.createFromAsset(this.getContext().getAssets(), "fonts/Proxima Nova Bold.ttf");
			this.setTypeface(ProximaNovaBoldTextView.typefaceName);
		}
	}
}
