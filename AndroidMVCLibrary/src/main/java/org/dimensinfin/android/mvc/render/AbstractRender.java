...
public abstract class AbstractRender<M extends ICollaboration> implements IRender {
	...
	private IAndroidController<M> controller; // Holds the parent controller that is associated to this render. Used to access the model.
	private Context context; // Reference to the context. Usually the application singleton.
	private View convertView = null;

	// - L A Y O U T   F I E L D S
	// - C O N S T R U C T O R - S E C T I O N
	public AbstractRender(final IAndroidController<M> controller, final Context context) {
	...
	public IAndroidController<M> getController() {
		return controller;
	}
