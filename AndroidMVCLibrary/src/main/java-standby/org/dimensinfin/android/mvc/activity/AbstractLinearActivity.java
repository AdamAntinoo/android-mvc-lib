	...
	public void addLinear( AbstractPagerFragment newFrag ) {
		...
		if ( null == frag ) {
			...
			if ( frag instanceof AbstractPagerFragment ) {
				...
				throw new RuntimeException("RTEX [AbstractLinearActivity.addLinear]> The fragment located does not inherit the required functionality. Does not extend AMVCPagerFragment.");
		}
