...
public abstract class NewMVCDataSource extends AbstractPropertyChanger implements IDataSource {
	...
	private static Logger logger = LoggerFactory.getLogger("NewMVCDataSource");
	...
	public void createContentHierarchy () {
		...
		//			ex.printStackTrace();
		//		}
		logger.info("<< [NewMVCDataSource.createContentHierarchy]> _dataSectionParts.size: {}", _bodyParts.size());
	}
