...
public class HeaderDataSourceAdapterTest {
	...
	public void builder() {
		...
		final DataSourceAdapter adapter = new HeaderDataSourceAdapter(fragment, dataSource).setHeaderContainer(container);
...
//	@Test
	public void notifyDataSetChanged() {
		...
		final HeaderDataSourceAdapter dsAdapter = new HeaderDataSourceAdapter(fragment, dataSource).setHeaderContainer(container);
